...
export default function AlmacenMateriales() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${darkMode ? 'from-[#181712] via-[#24180c] to-[#242126]' : 'from-orange-50 via-white to-gray-100'} text-white p-6 flex flex-col`}>
