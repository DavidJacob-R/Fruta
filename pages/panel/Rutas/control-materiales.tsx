    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <form onSubmit={handleEntradaSubmit}>
            ...
            >
                ...
                <option value="clamshell">Clamshell de plástico</option>
            ...
            <div className="mb-4">
                ...
                {tiposClamshell.map((t) => (
                    <option key={t.id} value={t.id}>{t.tamanio} oz</option>
                ))}
                </select>
            </div>
            )}
            ...
            <div className="mb-4">
                ...
                {tiposCaja.map((t) => (
                    <option key={t.id} value={t.id}>{t.nombre} ({t.capacidad} clamshells)</option>
                ))}
                </select>
            </div>
            )}
