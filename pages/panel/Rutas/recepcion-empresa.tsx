...
export default function RecepcionEmpresa() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-black via-gray-900 to-orange-900">
      ...
      <div className="flex flex-1 items-center justify-center py-10 px-2">
        <div className="w-full max-w-2xl mx-auto bg-white/10 backdrop-blur-xl border-2 border-orange-600 rounded-[32px] shadow-2xl p-0 md:p-10 flex flex-col items-center pt-10 md:pt-20 overflow-auto"
          style={{ minHeight: '80vh', marginTop: 16, marginBottom: 16 }}
        >
          {/* Branding */}
      ...
      {/* Footer fijo abajo */}
      <footer className="w-full text-center py-4 bg-black/70 text-gray-400 text-base opacity-80">
