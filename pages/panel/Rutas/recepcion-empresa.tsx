          ...
          <div className="py-10 px-6 md:px-12">
                ...
                <div className="flex flex-wrap gap-6 justify-center mb-2">
                  ...
                  {tiposFruta.map(fruta => (
                    <button
                      ...
                      style={{ minWidth: 200, minHeight: 56 }}>{fruta.nombre}</button>
                  ))}
                </div>
                <div className="mt-8 flex justify-between">
            ...
            {paso === 5 && (
              <section>
                ...
                <div className="flex justify-between">
                  <button onClick={() => setPaso(4)} className="text-orange-400 text-lg font-semibold underline">Volver</button>
                  <button
                    onClick={() => setPaso(6)}
                    className={`font-bold py-3 px-8 rounded-xl shadow transition border text-lg
                      ${darkMode
            ...
            {paso === 6 && (
              <section>
                ...
                <div className="flex justify-between">
                  <button onClick={() => setPaso(5)} className="text-orange-400 text-lg font-semibold underline">Volver</button>
                  <button
