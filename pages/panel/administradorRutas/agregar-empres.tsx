    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-8">
      ...
      <div className="w-full max-w-4xl flex flex-col md:flex-row md:justify-between items-center mb-6 gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight mb-1">
            <span className="text-orange-500">Gestión de Empresas</span>
          </h1>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            <label className="block text-gray-700 mb-1 font-medium">Nombre de la empresa *</label>
            <input
              name="empresa"
              value={form.empresa}
      ...
      <div className="w-full max-w-4xl mt-10">
        <h2 className="text-xl font-bold text-orange-600 mb-4">Empresas registradas</h2>
        {loading ? (
